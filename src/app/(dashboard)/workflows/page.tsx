...
const WORKFLOWS: Workflow[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Selecciona 5-7 noticias más relevantes para el nicho de Renan",
  ...
  },
  {
    ...
    steps: [
      ...
      "Redacta post de LinkedIn en la voz de Renan (profesional-cercano, sin emojis ni hashtags)",
  ...
  },
  {
    ...
    description: "Digest curado de las newsletters del día. Consolida lo mejor de las suscripciones de Renan en un resumen accionable.",
  ...
  },
  {
    ...
    description: "Categoriza y resume los emails del día para que Renan empiece la jornada sin inbox anxiety.",
    schedule: "7:45h (cada día)",
    trigger: "cron",
    status: "active",
    steps: [
  ...
  },
  {
    ...
    status: "active",
    steps: [
      "Renan envía /cfo, /cmo, /cto, /legal, /growth, /coach o /producto",
      "Tenacitas carga el skill advisory-board/SKILL.md",
      "Lee el archivo de memoria del advisor correspondiente (memory/advisors/)",
      "Responde en la voz y personalidad del advisor con contexto de Renan",
  ...
  },
  {
    ...
    steps: [
      ...
      "Notifica a Renan por Telegram con el resumen de lo implementado",
    ],
  },
];
